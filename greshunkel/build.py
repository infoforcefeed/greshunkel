...
PWD = getcwd()
POSTS_DIR = "{}/posts/".format(PWD)
TEMPLATE_DIR = "{}/templates/".format(PWD)
BLOGPOST_FILE = "blog_post.html"
BLOGPOST_TEMPLATE = TEMPLATE_DIR + BLOGPOST_FILE
BUILD_DIR = "{}/built/".format(PWD)
...
def main(context):
    from greshunkel.context import config as generated_context
    context = dict(context.items() + generated_context.items())
    all_templates = []
